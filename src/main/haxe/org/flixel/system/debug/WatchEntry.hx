...
class WatchEntry
{
	...
	public function new(Y:Float, NameWidth:Float, ValueWidth:Float, Obj:Dynamic, Field:String, ?Custom:String=null)
	{
		...
		_whiteText = new TextFormat(FlxAssets.nokiaFont, 8, 0xffffff);
		_blackText = new TextFormat(FlxAssets.nokiaFont, 8, 0);
